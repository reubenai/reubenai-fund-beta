...
BEGIN
  ...
  IF fund_type_value = 'venture_capital' OR fund_type_value = 'vc' THEN
    ...
    extracted_vc_data := extract_vc_data_from_crunchbase(NEW.data_retrieved);
    
    -- Update VC datapoints
    UPDATE public.deal_analysis_datapoints_vc 
    SET 
      deal_enrichment_crunchbase_export = NEW.data_retrieved,
  ...
  ELSIF fund_type_value = 'private_equity' OR fund_type_value = 'pe' THEN
    ...
    extracted_pe_data := extract_pe_data_from_crunchbase(NEW.data_retrieved);
...
BEGIN
  ...
  IF fund_type_value = 'venture_capital' OR fund_type_value = 'vc' THEN
    ...
    UPDATE public.deal_analysis_datapoints_vc 
    SET 
      deal_enrichment_linkedin_export = NEW.data_retrieved,
...
BEGIN
  ...
  IF fund_type_value = 'venture_capital' OR fund_type_value = 'vc' THEN
    ...
    UPDATE public.deal_analysis_datapoints_vc 
    SET 
      deal_enrichment_linkedin_profile_export = NEW.data_retrieved,
...
BEGIN
  ...
  IF fund_type_value = 'venture_capital' OR fund_type_value = 'vc' THEN
    ...
    UPDATE public.deal_analysis_datapoints_vc 
    SET 
      deal_enrichment_perplexity_company_export_vc = NEW.data_retrieved,
  ...
  ELSIF fund_type_value = 'private_equity' OR fund_type_value = 'pe' THEN
    ...
    UPDATE public.deal_analysis_datapoints_pe 
    SET 
      deal_enrichment_perplexity_company_export_pe = NEW.data_retrieved,
      source_engines = CASE WHEN 'perplexity_company' = ANY(source_engines) 
        THEN source_engines
        ELSE array_append(source_engines, 'perplexity_company') END,
      data_completeness_score = data_completeness_score + 15,
...
BEGIN
  ...
  IF fund_type_value = 'venture_capital' OR fund_type_value = 'vc' THEN
    ...
    UPDATE public.deal_analysis_datapoints_vc 
    SET 
      deal_enrichment_perplexity_founder_export_vc = NEW.data_retrieved,
  ...
  ELSIF fund_type_value = 'private_equity' OR fund_type_value = 'pe' THEN
    ...
    UPDATE public.deal_analysis_datapoints_pe 
    SET 
      deal_enrichment_perplexity_founder_export_pe = NEW.data_retrieved,
      source_engines = CASE WHEN 'perplexity_founder' = ANY(source_engines) 
        THEN source_engines
        ELSE array_append(source_engines, 'perplexity_founder') END,
      data_completeness_score = data_completeness_score + 12,
...
BEGIN
  ...
  IF fund_type_value = 'venture_capital' OR fund_type_value = 'vc' THEN
    ...
    UPDATE public.deal_analysis_datapoints_vc 
    SET 
      deal_enrichment_perplexity_market_export_vc = NEW.data_retrieved,
  ...
  ELSIF fund_type_value = 'private_equity' OR fund_type_value = 'pe' THEN
    ...
    UPDATE public.deal_analysis_datapoints_pe 
    SET 
      deal_enrichment_perplexity_market_export_pe = NEW.data_retrieved,
      source_engines = CASE WHEN 'perplexity_market' = ANY(source_engines) 
        THEN source_engines
        ELSE array_append(source_engines, 'perplexity_market') END,
      data_completeness_score = data_completeness_score + 15,
