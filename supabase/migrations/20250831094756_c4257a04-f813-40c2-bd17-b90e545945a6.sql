-- Phase 1: Fix Infrastructure Issues for VC Data Aggregator (Corrected Table Names)

-- 1. Create triggers for all enrichment data sources to fire on processing_status = 'completed'

-- Trigger for Perplexity Company VC Export (using the duplicate table that exists)
...
-- Trigger for Perplexity Founder VC Export (using the duplicate table that exists)
