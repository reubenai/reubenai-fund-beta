-- Enhanced Fund Memory: Phase 1 - Immediate Decision Data Capture
-- Create memory prompt triggers table for real-time insights
...
-- Create market signal responses table for strategic evolution tracking
...
-- Create policies for market signal responses
