...
-- Log the emergency shutdown activation with proper JSONB casting
...
('7ac26a5f-34c9-4d30-b09c-c05d1d1df81d', 
 (SELECT fund_id FROM deals WHERE id = '7ac26a5f-34c9-4d30-b09c-c05d1d1df81d'), 
 'emergency_shutdown', 
 'database_firewall', 
 'completed', 
 jsonb_build_object(
   'emergency_type', 'database_rls_shutdown',
   'reason', 'excessive_analysis_activity', 
   'timestamp', now(),
   'affected_tables', jsonb_build_array('deal_analysis_sources', 'artifacts', 'deal_analyses', 'deal_features', 'deal_scores', 'analysis_queue', 'ai_service_interactions', 'analysis_execution_log')
 ),
 now(), 
 now()),
('98c22f44-87c7-4808-be1c-31929c3da52f', 
 (SELECT fund_id FROM deals WHERE id = '98c22f44-87c7-4808-be1c-31929c3da52f'), 
 'emergency_shutdown', 
 'database_firewall', 
 'completed',
 jsonb_build_object(
