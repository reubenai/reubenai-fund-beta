...
export function BlueprintPEStrategicFit({ deal }: StrategicFitProps) {
  ...
  const strategicSubCriteria = [
    { id: 'fund-strategy-alignment', name: 'Fund Strategy Alignment', weight: 40, icon: <Target className="h-4 w-4" /> },
    { id: 'portfolio-synergies', name: 'Portfolio Synergies', weight: 35, icon: <Briefcase className="h-4 w-4" /> },
    { id: 'risk-return-profile', name: 'Risk-Return Profile', weight: 25, icon: <BarChart className="h-4 w-4" /> }
  ];
      ...
      <CardContent className="space-y-4">
                ...
                <div className="mt-3 space-y-3 bg-accent/20 p-3 rounded-lg">
                  ...
                  <div className="pt-2 border-t">
                    <p className="text-xs text-muted-foreground">
                      Assessment includes fund mandate alignment, portfolio synergy evaluation, and risk-return analysis.
                    </p>
                  </div>
                </div>
              </CollapsibleContent>
        ...
        <div className="mt-6 p-4 bg-muted/50 rounded-lg">
          ...
          <p className="text-sm text-muted-foreground">
            PE-focused strategic alignment analysis across {subCriteria.length} key criteria emphasizing fund fit and portfolio integration.
