...
export function BlueprintVCFinancialHealth({ deal }: FinancialHealthProps) {
  ...
  const financialSubCriteria = [
    { id: 'financial-projections', name: 'Financial Projections', weight: 60, icon: <Calculator className="h-4 w-4" /> },
    { id: 'funding-requirements', name: 'Funding Requirements', weight: 40, icon: <DollarSign className="h-4 w-4" /> }
  ];
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
                ...
                <div className="mt-3 space-y-3 bg-accent/20 p-3 rounded-lg">
                  ...
                  <div className="pt-2 border-t">
                    <p className="text-xs text-muted-foreground">
                      Assessment includes financial modeling, cash flow projections, and funding requirement analysis.
                    </p>
                  </div>
                </div>
              </CollapsibleContent>
        ...
        <div className="mt-6 p-4 bg-muted/50 rounded-lg">
          <h4 className="font-medium mb-2">Financial Health Summary</h4>
          <p className="text-sm text-muted-foreground">
            Comprehensive financial analysis across {subCriteria.length} key criteria focusing on projections and funding needs.
            Overall financial health: <span className={`font-medium ${getScoreColor(overallScore)}`}>{overallScore}%</span>
          </p>
        </div>
      </CardContent>
    </Card>
