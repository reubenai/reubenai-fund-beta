    ...
    <div className="max-w-7xl mx-auto px-6 py-8 space-y-6">
      ...
      <div className="bg-primary/10 border border-primary/20 rounded-lg p-4">
        ...
        <p className="text-sm text-muted-foreground">
          The v1 Thesis Configurator lets Fund Managers define and activate a Mandate per Fund, serving as the single source of truth for Deal Analysis, Deal Scoring (coming soon), and IC preparation.
        </p>
      </div>
